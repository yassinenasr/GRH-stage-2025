              ...
              demandes.map((d) => (
                <tr key={d.id} className="hover:bg-gray-100">
                  ...
                  <td className="border px-4 py-2 text-center space-x-2">
                    ...
                    <button className="rounded text-sm text-green-600 mr-2"  onClick={() => ChangeY(d.etat, i)}
>
                      Accepter
                    </button>
                    <button className="rounded text-sm text-red-500 mr-2">
                      Refuser
                    </button>
                  </td>
                </tr>
              ...
              evaluations.map((e) => (
                <tr key={e.id} className="hover:bg-gray-100">
                  ...
                  <td className="border px-4 py-2"> 
                    <button className="   rounded text-sm text-yellow-600 mr-2 ml-2">
        Modifier
                    </button>
                    <button className="   rounded text-sm text-green-600 mr-2">
        Accepter
                    </button>
                    <button className="   rounded text-sm text-red-500 mr-2">
        Supprimer
